const sections = [
  ...
  'Fundamentos de bases de datos/ELE07106709relacionales 8640',
...
const originalTitles = sections.map((_, index) => {
...
const apply = () => {
  chrome.storage.sync.get(null, (config) => {
    const fixTitles = config['fix-titles'];
